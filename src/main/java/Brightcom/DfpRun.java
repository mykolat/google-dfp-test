...
public class DfpRun {
    ...
    public static void runExample(DfpServices dfpServices, DfpSession session, long customFieldId)
        ...
        reportQuery.setDimensions(new Dimension[] {Dimension.DATE, Dimension.AD_UNIT_ID, Dimension.ADVERTISER_ID, Dimension.COUNTRY_NAME});
        reportQuery.setColumns(new Column[] {Column.TOTAL_INVENTORY_LEVEL_IMPRESSIONS});
