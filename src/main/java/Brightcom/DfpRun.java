...
import Brightcom.reports.data.OverallTraffic;
...
//            DfpRun.<Advertiser>runQuery(dfpServices, session, 10092788058L);
            DfpRun.<OverallTraffic>runQuery(dfpServices, session, 10092788996L);
//            }
     ...
     *                              complete.
     */
    public static <T extends ReportData> void runQuery(DfpServices dfpServices, DfpSession session, long queryId)
