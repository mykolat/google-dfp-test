...
public class DfpRun {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for(ReportQuery rep: reportArray){
                runExample(dfpServices, session, rep ,params.customFieldId);
            }
     ...
     *     complete.
     */
    public static void runExample(DfpServices dfpServices, DfpSession session, ReportQuery reportQuery, long customFieldId)
